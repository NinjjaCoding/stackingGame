...
function init() {
    ...
    camera = new THREE.OrthographicCamera(width / -2, width / 2, height / 2, height / -2, 0, 100 // far plane
    );
...
function startGame() {
    ...
    if (world) // Remove every object from world
...
function animation(time) {
    if (lastTime) {
        ...
        } else // If it shouldn't move then is it because the autopilot reached the correct position?
